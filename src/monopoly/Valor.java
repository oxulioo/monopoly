...
public final class Valor {
    ...
    public static final String RGB_TRANSPORTE = TEXTO_BLANCO + "\u001B[48;2;70;70;90m";      // Transporte (gris azulado)
    ...
    public static final String RGB_SUERTE     = TEXTO_BLANCO + "\u001B[48;2;0;153;76m";      // Suerte (verde esmeralda )
    public static final String RGB_ESPECIAL   = TEXTO_BLANCO + "\u001B[48;2;255;69;0m";      // Color común para todas las esquinas (rojo-anaranjado)
